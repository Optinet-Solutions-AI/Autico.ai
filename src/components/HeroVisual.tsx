...
// Brand-matched: blue (#3DA0EC) primary, cyan (#00E5CC) UI accent, white core.
  ...
  return (
    <div className="relative w-full aspect-square max-w-[560px] mx-auto">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 50%, rgba(61,160,236,0.32) 0%, rgba(0,229,204,0.12) 35%, transparent 65%)",
        }}
      />
      ...
      <svg viewBox="0 0 600 600" className="relative w-full h-full">
        <defs>
          <linearGradient id="ring-grad" x1="0" y1="0" x2="600" y2="0">
            <stop offset="0" stopColor="rgba(61,160,236,0.85)" />
            <stop offset="0.5" stopColor="rgba(0,229,204,0.55)" />
            <stop offset="1" stopColor="rgba(61,160,236,0.2)" />
          </linearGradient>
          <radialGradient id="glow" cx="50%" cy="50%" r="50%">
            <stop offset="0" stopColor="rgba(61,160,236,0.55)" />
            <stop offset="1" stopColor="rgba(61,160,236,0)" />
          </radialGradient>
        ...
        <g className="orbit-slow" style={{ transformOrigin: "300px 300px" }}>
          ...
          <circle cx="540" cy="300" r="6" fill="#3DA0EC" />
          <circle cx="60" cy="300" r="4" fill="#00E5CC" opacity="0.7" />
        </g>

        {/* Mid orbit (counter rotating) */}
        <g className="orbit-rev" style={{ transformOrigin: "300px 300px" }}>
          <circle cx="300" cy="300" r="180" fill="none" stroke="rgba(61,160,236,0.35)" strokeWidth="1" />
          <circle cx="480" cy="300" r="5" fill="#3DA0EC" />
          <circle cx="120" cy="300" r="3" fill="#00E5CC" opacity="0.85" />
        </g>

        {/* Inner orbit */}
        <g className="orbit-slow" style={{ transformOrigin: "300px 300px", animationDuration: "12s" }}>
          <circle cx="300" cy="300" r="120" fill="none" stroke="rgba(0,229,204,0.4)" strokeWidth="1" strokeDasharray="4 4" />
          <circle cx="420" cy="300" r="4" fill="#00E5CC" />
          <circle cx="180" cy="300" r="3" fill="#3DA0EC" />
        </g>
        ...
        <g opacity="0.3" stroke="#3DA0EC" strokeWidth="0.8" fill="none">
        ...
        {/* Satellite nodes */}
        <g>
          <circle cx="300" cy="60" r="6" fill="#3DA0EC" />
          <circle cx="540" cy="180" r="5" fill="#00E5CC" />
          <circle cx="540" cy="420" r="5" fill="#3DA0EC" opacity="0.85" />
          <circle cx="300" cy="540" r="6" fill="#00E5CC" />
          <circle cx="60" cy="420" r="5" fill="#3DA0EC" />
          <circle cx="60" cy="180" r="4" fill="#FFFFFF" opacity="0.7" />
        </g>
      </svg>
    </div>
  );
