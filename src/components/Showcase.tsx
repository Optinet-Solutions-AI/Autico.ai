      ...
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-2 text-3xl md:text-4xl font-semibold tracking-tight">30 AI products. Battle-tested blueprints.</h2>
          ...
          <a href="/showcase" className="text-[14px] text-[var(--color-fg-muted)] hover:text-[var(--color-fg)] transition">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {products.map((p) => (
            ...
            >
              ...
              <div className="relative mt-6 flex items-center gap-1.5 text-[12.5px] text-[var(--color-fg-dim)] transition group-hover:text-[var(--color-accent)]">
